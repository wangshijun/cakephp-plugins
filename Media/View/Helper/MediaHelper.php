 ...
 * of a controller:
 * {{{
 *     var $helpers = array('Form', 'Html', 'Media');
 * }}}
 *
 * If needed you can also pass additional path to URL mappings when
 * loading the helper:
 * {{{
 *     var $helpers = array('Media' => array(MEDIA_FOO => 'foo/'));
 * }}}
 *
 ...
 */
	protected function _addDimensions($file, $attributes = array()) {
 ...
 */
	protected function _parseAttributes($options, $exclude = NULL, $insertBefore = ' ', $insertAfter = NULL) {
		...
		return parent::_parseAttributes($options, $exclude, $insertBefore, $insertAfter) . ' ' . implode(' ', $attributes);
	}
